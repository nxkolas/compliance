      ...
      <div className="mt-10 grid gap-5">
        ...
        <details className="rounded-xl border-[1.5px] border-[#3D4049] bg-[#1B1E27] p-5 text-sm text-white shadow-sm">
          ...
          <dl className="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            />
            <Technical label={labels.technical.release} value={release.versionLabel} />
            <Technical
        ...
        {generating ? (
          ...
          <Button
            className="h-12 justify-self-end bg-[#002BFF] px-7 text-white hover:bg-[#123BFF]"
