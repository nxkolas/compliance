  ...
  de: {
    modules: {
          ...
          documents: {
            title: "Dokumente",
            description:
              "Laden Sie organisationsweite Dokumente einmalig hoch und verwalten Sie deren Status.",
            workflow: {
  ...
  en: {
    modules: {
          ...
          documents: {
            title: "Documents",
            description:
              "Upload organization-wide documents once and manage their lifecycle.",
            workflow: {
