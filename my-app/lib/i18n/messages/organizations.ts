...
export const organizationsMessages = defineFeatureMessages({
  de: {
    ...
    organizationManagement: {
      ...
      archive: "Organisation löschen",
      restore: "Organisation wiederherstellen",
      archiveTitle: "Organisation archivieren/löschen?",
      archiveDescription: "Möchten Sie die Organisation {name} und alle dazugehörigen Daten unwiderruflich löschen? Dieser Vorgang kann nicht rückgängig gemacht werden.",
      ...
      legalName: "Rechtlicher Name",
      country: "Land",
      aiPolicy: "OpenAI erlauben",
      aiPolicyDescription: "Erlaubt die Nutzung von OpenAI für die Gap-Analyse und die Erstellung des Maßnahmenplans. Dabei können ausgewählte Rechts- und Organisationsinformationen an OpenAI übermittelt werden.",
      reason: "Grund der Richtlinienänderung",
    ...
    teamManagement: {
      title: "Mitglieder",
      manageDescription: "Rollen verwalten sowie Mitglieder entfernen oder wiederherstellen.",
      ...
      role: "Rolle",
      roles: { owner: "Inhaber", admin: "Administration", member: "Mitglied", auditor: "Prüfung" },
  ...
  en: {
    ...
    organizationManagement: {
      ...
      legalName: "Legal name",
      country: "Country",
      aiPolicy: "Allow OpenAI",
      aiPolicyDescription: "Allows OpenAI to be used for the gap analysis and creation of the action plan. Selected legal and organization information may be sent to OpenAI.",
    ...
    teamManagement: {
      title: "Members",
      manageDescription: "Manage roles and remove or restore members.",
      ...
      role: "Role",
      roles: { owner: "Owner", admin: "Administrator", member: "Member", auditor: "Auditor" },
