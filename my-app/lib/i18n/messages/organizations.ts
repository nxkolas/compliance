...
export const organizationsMessages = defineFeatureMessages({
  de: {
    ...
    organizationManagement: {
      ...
      archiveTitle: "Organisation löschen?",
      ...
      archiveSuccess: "Organisation wurde gelöscht.",
    ...
    inbox: {
          ...
          emptyDescription: "Einladungen zu Organisationen werden hier angezeigt, sobald Sie eine erhalten.",
          role: "Rolle",
          invitedByOrganization: "Eingeladen von {organization}",
          roles: {
            owner: "Inhaber",
          ...
          decline: "Ablehnen",
          declineUnavailable: "Das Ablehnen von Einladungen ist derzeit noch nicht verfügbar.",
          accept: "Akzeptieren",
  ...
  en: {
    ...
    organizationManagement: {
      ...
      archiveTitle: "Delete organization?",
      ...
      archiveSuccess: "Organization deleted.",
    ...
    inbox: {
          ...
          emptyTitle: "All done.",
          emptyDescription: "Organization invitations will appear here as soon as you receive one.",
          role: "Role",
          invitedByOrganization: "Invited by {organization}",
          roles: {
            owner: "Owner",
          ...
          decline: "Decline",
          declineUnavailable: "Declining invitations is not available yet.",
          accept: "Accept",
