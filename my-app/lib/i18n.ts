    ...
    modules: {
      ...
      documents: {
        ...
        workflow: {
          ...
          usage: {
            ...
            used_in_candidate_revision: "In Kandidatenrevision verwendet",
            used_in_approved_revision: "In genehmigter Revision verwendet",
      ...
      actionPlan: {
        ...
        workflow: {
          ...
          updateAvailable: "Für ein neueres genehmigtes Gap-Ergebnis ist eine Planaktualisierung verfügbar.",
          prepareUpdate: "Planabgleich vorbereiten",
      ...
      gapAnalysis: {
        ...
        workflow: {
          ...
          questionnaire: "Fragebogen",
          questionnaireSource: "1. Fragebogenquelle",
          evidencePreparation: "2. Nachweise vorbereiten",
          confirmation: "3. Eingaben bestätigen und Generierung starten",
          candidateResult: "4. Kandidatenrevision prüfen",
          acceptedResult: "5. Genehmigtes Ergebnis",
          baseRevision: "Basisrevision",
          questionnaireRevision: "Fragebogenrevision",
          release: "Gap-Analyse-Version",
          carriedEvidence: "Übernommene Nachweise",
          replacedEvidence: "Ersetzte Nachweise",
          addedEvidence: "Hinzugefügte Nachweise",
          removedEvidence: "Entfernte Nachweise",
          completeEvidence: "Vollständiger Nachweissatz",
          requirementCount: "Zu bewertende Anforderungen",
          inputLocked: "Die bestätigten Eingaben sind für diese Generierung gesperrt.",
          noAcceptedResult: "Noch ist kein genehmigtes Ergebnis vorhanden.",
    ...
    modules: {
      ...
      documents: {
        ...
        workflow: {
          ...
          usage: {
            ...
            used_in_candidate_revision: "Used in candidate revision",
            used_in_approved_revision: "Used in approved revision",
      ...
      actionPlan: {
        ...
        workflow: {
          ...
          updateAvailable: "A plan update is available for a newer accepted gap result.",
          prepareUpdate: "Prepare plan reconciliation",
      ...
      gapAnalysis: {
        ...
        workflow: {
          ...
          questionnaire: "Questionnaire",
          questionnaireSource: "1. Questionnaire source",
          evidencePreparation: "2. Prepare evidence",
          confirmation: "3. Confirm inputs and start generation",
          candidateResult: "4. Review candidate revision",
          acceptedResult: "5. Accepted result",
          baseRevision: "Base revision",
          questionnaireRevision: "Questionnaire revision",
          release: "Gap-analysis release",
          carriedEvidence: "Carried evidence",
          replacedEvidence: "Replaced evidence",
          addedEvidence: "Added evidence",
          removedEvidence: "Removed evidence",
          completeEvidence: "Complete evidence set",
          requirementCount: "Requirements to evaluate",
          inputLocked: "The confirmed inputs are locked for this generation.",
          noAcceptedResult: "No accepted result exists yet.",
          required: "Required",
