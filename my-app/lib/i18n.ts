    ...
    modules: {
      ...
      actionPlan: {
        ...
        workflow: {
          ...
          noApprovedRevision: "Genehmigen Sie zuerst ein Gap-Analyse-Ergebnis.",
          ...
          saving: "Speichert …",
          empty: "Das genehmigte Ergebnis enthält keine offenen Maßnahmen.",
      ...
      gapAnalysis: {
        ...
        workflow: {
          ...
          prerequisiteTitle: "Voraussetzung",
          prerequisite: "Ein genehmigter Betroffenheitscheck der kompatiblen Version ist erforderlich.",
          create: "Gap-Analyse starten",
          questionnaire: "Fragebogen",
          required: "Pflichtfeld",
          submitQuestionnaire: "Fragebogen speichern",
          documents: "Dokumentnachweise",
          documentHint: "Unterstützt werden Text-PDF, DOCX, TXT und Markdown bis 10 MB.",
          documentTitle: "Dokumenttitel",
          documentFile: "Datei",
          upload: "Dokument hochladen und indexieren",
          archive: "Archivieren",
          indexed: "Indexiert",
          processing: "Verarbeitung läuft",
          failed: "Verarbeitung fehlgeschlagen",
          selectEvidence: "Für diese Generierung auswählen",
          generate: "Gap-Analyse generieren",
          retry: "Generierung ausdrücklich wiederholen",
          generating: "Analyse wird generiert …",
          questionnaireOnly: "Die Analyse kann ohne Dokumente erstellt werden; ein erfüllter Status ist dann ausgeschlossen.",
          runFailed: "Die letzte Generierung ist fehlgeschlagen.",
          findings: "Anforderungsbewertungen",
          ...
          resolutionReason: "Auflösung des Widerspruchs",
          saveCorrection: "Korrektur als neue Revision speichern",
          approve: "Vollständige Revision genehmigen",
          approved: "Genehmigt",
          stale: "Quellen haben sich seit dieser Revision geändert.",
          outdatedRelease: "Eine neuere Gap-Analyse-Version ist aktiv.",
          ownerOnly: "Nur Eigentümer und Administratoren dürfen korrigieren und genehmigen.",
          ...
          statuses: {
            ...
            insufficient_evidence: "Unzureichende Nachweise",
          },
        },
      },
      helpGlossary: {
    ...
    modules: {
      ...
      actionPlan: {
        ...
        workflow: {
          ...
          noApprovedRevision: "Approve a gap-analysis result first.",
          ...
          save: "Save changes",
          saving: "Saving…",
          empty: "The approved result contains no open actions.",
      ...
      gapAnalysis: {
        ...
        workflow: {
          ...
          prerequisite: "An approved applicability result from the compatible release is required.",
          create: "Start gap analysis",
          questionnaire: "Questionnaire",
          required: "Required",
          submitQuestionnaire: "Save questionnaire",
          documents: "Document evidence",
          documentHint: "Text PDF, DOCX, TXT, and Markdown up to 10 MB are supported.",
          documentTitle: "Document title",
          documentFile: "File",
          upload: "Upload and index document",
          archive: "Archive",
          indexed: "Indexed",
          processing: "Processing",
          failed: "Processing failed",
          selectEvidence: "Select for this generation",
          generate: "Generate gap analysis",
          retry: "Explicitly retry generation",
          generating: "Generating analysis…",
          questionnaireOnly: "The analysis can run without documents; fulfilled is then unavailable.",
          runFailed: "The latest generation failed.",
          ...
          resolutionReason: "Conflict resolution",
          saveCorrection: "Save correction as a new revision",
          approve: "Approve complete revision",
          approved: "Approved",
          stale: "Sources changed after this revision.",
          outdatedRelease: "A newer gap-analysis release is active.",
          ownerOnly: "Only owners and administrators may correct and approve.",
