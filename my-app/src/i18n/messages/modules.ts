    ...
    modules: {
          ...
          documents: {
            ...
            workflow: {
              ...
              uploadSuccess: "Das Dokument wurde hochgeladen und wird indexiert.",
              archiveSuccess: "Das Dokument wurde archiviert.",
              restoreSuccess: "Das Dokument wurde wiederhergestellt.",
              retrySuccess: "Die erneute Indexierung wurde gestartet.",
          ...
          actionPlan: {
            ...
            workflow: {
              ...
              preparationInfo: "Ihr bisheriger Fortschritt bleibt erhalten. Über den Button gelangen Sie zum passenden nächsten Schritt. Die vollständige Erklärung finden Sie im NIS2-Tutorial in der Seitenleiste.",
              preparation: {
                applicability_missing: { title: "Ihr Maßnahmenplan ist noch nicht verfügbar", description: "Starten Sie mit dem Betroffenheitscheck. Anschließend zeigt die Gap-Analyse Ihre Lücken und bildet die Grundlage für Ihren Maßnahmenplan.", action: "Betroffenheitscheck durchführen" },
                applicability_review: { title: "Bitte prüfen Sie Ihr Betroffenheitsergebnis", description: "Der Betroffenheitscheck gibt die Gap-Analyse aktuell nicht frei. Öffnen Sie Ihr Ergebnis, um den genauen Hinweis und die nächsten Schritte zu sehen.", action: "Betroffenheitsergebnis ansehen" },
                gap_pending: { title: "Setzen Sie Ihre Gap-Analyse fort", description: "Ihr Betroffenheitscheck ist abgeschlossen. Schließen Sie nun die Gap-Analyse einschließlich der Auswertung ab. Aus den festgestellten Lücken entsteht anschließend Ihr Maßnahmenplan.", action: "Gap-Analyse fortsetzen" },
                gap_generating: { title: "Ihre Gap-Analyse wird ausgewertet", description: "Die Auswertung läuft noch. Sobald Ihre Ergebnisse vorliegen, können Sie mögliche Prüfpunkte klären und Ihren Maßnahmenplan erstellen.", action: "Auswertung ansehen" },
                review: { title: "Bitte klären Sie noch die Prüfpunkte", description: "Ihre Gap-Ergebnisse liegen vor. Zwischen den Angaben und Nachweisen bestehen noch ungeklärte Widersprüche. Prüfen Sie die markierten Stellen, damit Ihr Maßnahmenplan auf eindeutigen Ergebnissen basiert.", action: "Prüfpunkte ansehen" },
                no_gaps: { title: "Aktuell bestehen keine offenen Lücken", description: "In Ihrer Gap-Analyse sind alle bewerteten Anforderungen als erfüllt eingestuft. Aus diesem Ergebnis müssen keine offenen Maßnahmen erstellt werden.", action: "Ergebnis ansehen" },
                permission: { title: "Die Planerstellung benötigt eine Berechtigung", description: "Ihre Gap-Ergebnisse liegen vor. Mit Ihrer aktuellen Rolle können Sie keinen Maßnahmenplan erstellen. Bitten Sie einen Organisationsadministrator oder ein Mitglied mit entsprechender Berechtigung um die Erstellung.", action: "Gap-Ergebnis ansehen" },
                outdated: { title: "Bitte aktualisieren Sie Ihre Gap-Analyse", description: "Das gespeicherte Gap-Ergebnis basiert auf einer älteren Anforderungsversion. Öffnen Sie die Gap-Analyse und folgen Sie den Hinweisen zur Aktualisierung.", action: "Gap-Analyse ansehen" },
                unavailable: { title: "Ihr Gap-Ergebnis ist noch nicht freigegeben", description: "Ein Gap-Ergebnis ist vorhanden, kann aktuell aber noch nicht für die Planerstellung verwendet werden. Öffnen Sie die Gap-Analyse und prüfen Sie den angezeigten Status.", action: "Gap-Ergebnis prüfen" },
                generating: { title: "Ihr Maßnahmenplan wird erstellt", description: "Die Erstellung wurde gestartet. Lassen Sie diese Seite geöffnet; der Status wird automatisch aktualisiert. Sie müssen die Erstellung nicht erneut starten.", action: "Plan wird erstellt …" },
                failed: { title: "Ihr Maßnahmenplan konnte nicht erstellt werden", description: "Die letzte Erstellung wurde nicht erfolgreich abgeschlossen. Ihre Gap-Ergebnisse bleiben erhalten. Sie können die Erstellung erneut versuchen.", action: "Erneut versuchen" },
              },
              ...
              whySequenceExplanation: "Zuerst prüft der Betroffenheitscheck, ob Ihre Organisation in den betrachteten NIS2-Anwendungsbereich fällt. Darauf aufbauend zeigt die Gap-Analyse, welche Anforderungen bereits erfüllt sind und wo noch Lücken bestehen. Aus diesen Ergebnissen entsteht Ihr Maßnahmenplan mit priorisierten Aufgaben.\n\nDie vollständige Erklärung finden Sie im NIS2-Tutorial. Sie können es über „NIS2-Tutorial starten“ in der Seitenleiste öffnen.",
          ...
          gapAnalysis: {
            ...
            workflow: {
              ...
              prerequisiteWhySequenceExplanation: "Zuerst prüft der Betroffenheitscheck, ob Ihre Organisation in den betrachteten NIS2-Anwendungsbereich fällt. Darauf aufbauend zeigt die Gap-Analyse, welche Anforderungen bereits erfüllt sind und wo noch Lücken bestehen. Aus diesen Ergebnissen entsteht Ihr Maßnahmenplan mit priorisierten Aufgaben.\n\nDie vollständige Erklärung finden Sie im NIS2-Tutorial. Sie können es über „NIS2-Tutorial starten“ in der Seitenleiste öffnen.",
              ...
              startTitle: "Gap-Analyse starten",
              startDescription: "Beantworten Sie gezielte Fragen zu Bereichen Ihrer IT-Sicherheit.\nSo erkennen Sie bestehende Sicherheitslücken und konkreten Handlungsbedarf.",
              startAnalysis: "Gap-Analyse starten",
              ...
              savedQuestionProgress: "{answered} von {total} Pflichtfragen auf dem Server gespeichert",
              ...
              preparingEvidence: "Nachweise werden vorbereitet",
              waitingForClient: "Warten auf einen verbundenen Browser",
              waitingForClientHint: "Öffnen Sie die lokalen Modelleinstellungen dieser Organisation und verbinden Sie sich, damit die Analyse fortgesetzt werden kann.",
              generatingCategories: "{completed} von {total} Kategorien abgeschlossen",
              validatingAnalysis: "Die Analyse wird geprüft",
              savingResult: "Das Ergebnis wird gespeichert",
    ...
    modules: {
          ...
          documents: {
            ...
            workflow: {
              ...
              uploadSuccess: "The document was uploaded and is being indexed.",
              archiveSuccess: "The document was archived.",
              restoreSuccess: "The document was restored.",
              retrySuccess: "Re-indexing was started.",
          ...
          actionPlan: {
            ...
            workflow: {
              ...
              preparationInfo: "Your progress is saved. The button takes you to the appropriate next step. For the full explanation, open the NIS2 tutorial in the sidebar.",
              preparation: {
                applicability_missing: { title: "Your action plan is not available yet", description: "Start with the applicability check. The gap analysis then identifies gaps and provides the basis for your action plan.", action: "Start applicability check" },
                applicability_review: { title: "Please review your applicability result", description: "The applicability result does not currently allow a gap analysis. Open it to see the specific notice and next steps.", action: "View applicability result" },
                gap_pending: { title: "Continue your gap analysis", description: "Your applicability check is complete. Finish the gap analysis, including its evaluation. The identified gaps then form the basis of your action plan.", action: "Continue gap analysis" },
                gap_generating: { title: "Your gap analysis is being evaluated", description: "The evaluation is still running. Once the results are available, resolve any review points and create your action plan.", action: "View evaluation" },
                review: { title: "Please resolve the remaining review points", description: "Your gap results are available, but there are unresolved contradictions between answers and evidence. Review the marked findings so your action plan is based on clear results.", action: "View review points" },
                no_gaps: { title: "There are currently no open gaps", description: "All evaluated requirements in your gap analysis are marked as fulfilled. No open actions need to be created from this result.", action: "View result" },
                permission: { title: "Creating a plan requires permission", description: "Your gap results are available. Your current role cannot create an action plan. Ask an organization administrator or a member with the required permission to create it.", action: "View gap result" },
                outdated: { title: "Please update your gap analysis", description: "The saved gap result uses an older requirement version. Open the gap analysis and follow the instructions for updating it.", action: "View gap analysis" },
                unavailable: { title: "Your gap result is not ready for a plan yet", description: "A gap result exists but cannot currently be used to create a plan. Open the gap analysis and review its status.", action: "Review gap result" },
                generating: { title: "Your action plan is being created", description: "Creation has started. Keep this page open; its status updates automatically. You do not need to start it again.", action: "Creating plan …" },
                failed: { title: "Your action plan could not be created", description: "The last attempt did not finish successfully. Your gap results are saved. You can try creating the plan again.", action: "Try again" },
              },
              createPlanDescription:
              ...
              whySequenceExplanation: "First, the applicability check assesses whether your organization falls within the NIS2 scope covered by the tool. The gap analysis then shows which requirements are fulfilled and where gaps remain. These results form the basis of your action plan with prioritized tasks.\n\nFor the full explanation, open the NIS2 tutorial using the tutorial entry in the sidebar.",
          ...
          gapAnalysis: {
            ...
            workflow: {
              ...
              prerequisiteWhySequenceExplanation: "First, the applicability check assesses whether your organization falls within the NIS2 scope covered by the tool. The gap analysis then shows which requirements are fulfilled and where gaps remain. These results form the basis of your action plan with prioritized tasks.\n\nFor the full explanation, open the NIS2 tutorial using the tutorial entry in the sidebar.",
              ...
              startTitle: "Start your gap analysis",
              startDescription: "Answer targeted questions about your IT security.\nIdentify existing security gaps and where action is needed.",
              startAnalysis: "Start Gap Analysis",
              ...
              savedQuestionProgress: "{answered} of {total} required answers saved on the server",
              ...
              preparingEvidence: "Preparing evidence",
              waitingForClient: "Waiting for a connected browser",
              waitingForClientHint: "Open this organization's Local model settings and connect to keep serving this analysis.",
              generatingCategories: "{completed} of {total} categories complete",
              validatingAnalysis: "Validating the analysis",
