...
import { getCurrentActionPlan } from "./action-plan";
import {
  prepareGroundingOperation,
  runGroundedOperation,
} from "../grounding/gateway";
import type { GroundingContextItem } from "../grounding/types";
import {
...
import {
  ...
  actionPlanOutputLocaleInstruction,
...
} from "../../platform/ai/generation";
import { configuredCategoryConcurrency } from "../../platform/ai/generation/concurrency";
import { assertLiveParentJobForAiRun } from "../../platform/ai/generation/job-run-lifecycle";
...
export async function executeActionPlanGenerationJob(input: {
  ...
  groundingDependencies?: import("../grounding/gateway").GroundingExecutionDependencies;
}) {
  ...
  >({
    ...
    async generate({
      ...
      const grounded = await runGroundedOperation<ActionPlanCategoryResponse>({
        ...
        outputLocaleInstruction: actionPlanOutputLocaleInstruction(input.locale),
        systemInstruction:
          phase === "initial"
