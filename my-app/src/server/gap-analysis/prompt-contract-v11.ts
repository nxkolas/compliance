...
import type { GapStatementSemanticContext } from "./generation-schema-v11";

export const GAP_PROMPT_V11_NAME = "nis2_atomic_gap_analysis";
export const GAP_PROMPT_V11_VERSION = "11";
export const GAP_RESPONSE_SCHEMA_V11_VERSION = "11";

export function gapPromptV11(input: {
  locale: "de" | "en";
...
export const GAP_PROMPT_V11_TEMPLATE = gapPromptV11({
  locale: "en",
  semanticContexts: [],
});
export const GAP_PROMPT_V11_TEMPLATE_HASH = contentHash({
  en: gapPromptV11({ locale: "en", semanticContexts: [] }),
  de: gapPromptV11({ locale: "de", semanticContexts: [] }),
});

export function gapRepairPromptV11(input: {
  locale: "de" | "en";
  categoryCode: string;
  semanticContexts: GapStatementSemanticContext[];
  issues: Array<{
