...
const expectedTables = [
  ...
  "audit_events", "background_jobs", "document_chunks", "document_versions", "documents",
  ...
  "organization_embedding_migrations", "organization_memberships", "organizations", "platform_audit_events",
