...
export const ACTION_PLAN_PROMPT_V6_NAME = "nis2_action_plan";
export const ACTION_PLAN_PROMPT_V6_VERSION = "6";
export const ACTION_PLAN_RESPONSE_SCHEMA_V6_VERSION = "6";

export function actionPlanPromptV6(locale: "de" | "en") {
  const language =
    locale === "de"
...
export const ACTION_PLAN_PROMPT_V6_TEMPLATE = actionPlanPromptV6("en");
export const ACTION_PLAN_PROMPT_V6_TEMPLATE_HASH = contentHash({
  en: actionPlanPromptV6("en"),
  de: actionPlanPromptV6("de"),
});

export function actionPlanRepairPromptV6(input: {
  locale: "de" | "en";
  categoryCode: string;
  issues: Array<{
  ...
  return `${actionPlanPromptV6(input.locale)}
