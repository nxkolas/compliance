    ...
    <main className="dark min-h-screen overflow-hidden bg-transparent text-white">
      <header className="dark fixed inset-x-0 top-0 z-40 h-28 bg-[#02040E]/25 text-white backdrop-blur-md">
        <div className="relative mx-auto flex h-full max-w-[1728px] items-start gap-8 px-6 pb-14 pt-4 sm:items-center sm:px-10 sm:py-0 lg:px-12 xl:px-[72px]">
          ...
          <div className="absolute bottom-3 right-4 max-w-48 text-sm [&_a:first-child]:h-10 [&_a:first-child]:w-36 [&_a:first-child]:self-center [&_a:first-child]:justify-center [&_a:first-child]:rounded-lg [&_a:first-child]:border [&_a:first-child]:border-white/70 [&_a:first-child]:bg-[linear-gradient(135deg,rgba(0,43,255,0.16),rgba(255,255,255,0.03))] [&_a:first-child]:px-4 [&_a:first-child]:py-0 [&_a:first-child]:font-sans [&_a:first-child]:text-sm [&_a:first-child]:font-medium [&_a:first-child]:leading-normal [&_a:first-child]:text-white/95 [&_a:first-child]:shadow-[0_4px_16px_rgba(0,43,255,0.18)] [&_a:first-child]:transition-all [&_a:first-child]:hover:-translate-y-0.5 [&_a:first-child]:hover:border-white [&_a:first-child]:hover:bg-[linear-gradient(135deg,rgba(0,43,255,0.26),rgba(255,255,255,0.06))] [&_a:first-child]:hover:text-white [&_a:first-child]:hover:shadow-[0_7px_20px_rgba(0,43,255,0.28)] [&_a:first-child]:active:translate-y-0 [&_a:last-child]:inline-flex [&_a:last-child]:h-10 [&_a:last-child]:w-36 [&_a:last-child]:items-center [&_a:last-child]:justify-center [&_a:last-child]:overflow-hidden [&_a:last-child]:rounded-lg [&_a:last-child]:border-0 [&_a:last-child]:bg-[#002BFF] [&_a:last-child]:font-sans [&_a:last-child]:text-sm [&_a:last-child]:font-medium [&_a:last-child]:text-white [&_a:last-child]:shadow-[0_6px_18px_rgba(0,43,255,0.32)] [&_a:last-child]:transition-all [&_a:last-child]:hover:-translate-y-0.5 [&_a:last-child]:hover:bg-[#002BFF] [&_a:last-child]:hover:shadow-[0_9px_24px_rgba(0,43,255,0.46)] [&_a:last-child]:active:translate-y-0 sm:static sm:mr-32 sm:max-w-none">
            {hasEnvVars ? (
